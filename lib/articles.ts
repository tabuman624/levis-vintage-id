...
export const ARTICLES: Article[] = [
  ...
  {
    slug: 'article-jacket-authentic',
    catJa: '価値・希少性', catEn: 'Value & Rarity',
    titleJa: 'ヴィンテージLevi\'sジャケット真贋判定ガイド｜LVC復刻品・後付けパーツとの見分け方',
    titleEn: 'Vintage Levi\'s Jacket Authentication Guide — Spotting LVC Reproductions and Modified Parts',
    descJa: 'Big EジャケットとLVC復刻品の見分け方、タブ・ケアラベル整合性チェック、ジッパー・ボタン真贋確認、購入前チェックリストを完全解説。',
    descEn: 'How to distinguish Big E jackets from LVC reproductions, tab/care label consistency checks, zipper and button authentication, and a full pre-purchase checklist.',
    tags: ['真贋', 'LVC', 'Big E', 'ジャケット', '偽物', '鑑定'],
    publishedAt: '2026-05-31',
    sections: [
      {
        headingJa: 'ジャケット真贋問題の3つのパターン',
        headingEn: 'Three Patterns of Jacket Authentication Issues',
        bodyJa: 'ヴィンテージLevi\'sジャケット市場には「本物に見えるが本物でない」ケースが主に3種類あります。①LVC（Levi\'s Vintage Clothing）復刻品：オフィシャルの復刻ラインで品質が高く、Big Eタブを使用しているためタブだけでは判別できません。②後期品を前期品として出品：Small e期の557XXをBig E期として、またはType Ⅲをプリーツの有無で「Type Ⅱ」と偽るケースがあります。③パーツのすり替え：別個体からタブ・ケアラベルを移植したもので、縫製痕の不自然さで見分けられます。これは明確な詐欺行為です。どのパターンにも共通する防衛策は「単一のポイントで判断しない」ことです。タブ・ケアラベル・ジッパー・デニム生地・縫製状態の5点を組み合わせた複合確認が適正な鑑定の基本となります。特に高額な取引では複数の確認ポイントを揃えた画像を要求することが自衛の第一歩です。',
        bodyEn: 'Three main patterns of "looks authentic but isn\'t" appear in the vintage Levi\'s jacket market. ①LVC (Levi\'s Vintage Clothing) reproductions: official high-quality reproductions using Big E tabs — tabs alone cannot distinguish them from originals. ②Later pieces sold as earlier ones: Small e era 557XX sold as Big E, or Type III sold as "Type II" by misrepresenting pleats. ③Parts transplants: tabs or care labels transferred from another garment — recognizable by unnatural stitching marks. This constitutes outright fraud. The common defense against all three patterns is "never judge by a single point." Combining tab + care label + zipper + denim fabric + stitching condition into a five-point check is the foundation of proper authentication. For high-value transactions, requesting complete photo documentation of all verification points is your first line of defense.',
      },
      {
        headingJa: 'LVC（Levi\'s Vintage Clothing）との確実な見分け方',
        headingEn: 'Reliable Methods to Distinguish LVC Reproductions',
        bodyJa: 'LVCはType Ⅰ・Ⅱ・Ⅲ全ての復刻品を製造しており、品質が高いため見分けにくいケースがあります。最も確実な判別方法はケアラベルの確認です。LVCは必ず「LEVIS VINTAGE CLOTHING」の表記があるケアラベルが付いています。また「MADE IN JAPAN」などの製造国表記も入っています。次点としてボタン裏の刻印を確認します。LVCのボタンはオリジナルの工場コード番号と異なる刻印パターンが入っていることが多く、刻印の字体や配置がオリジナルと微妙に異なります。タブはBig E仕様を再現していますが、タブ素材の感触・経年による退色の自然さ・縫い付け方の細部（折り返しの向き）に違いが現れます。価格帯も参考になります。LVCの定価は5〜10万円程度ですが、「オリジナルのBig E期」として数十万円で出品されているケースがあります。LVCは高品質で独自の価値がありますが、オリジナルヴィンテージとしての価値とは別物です。',
        bodyEn: 'LVC reproduces all three Types with high quality, making differentiation challenging. The most reliable method is the care label: LVC always attaches a care label reading "LEVIS VINTAGE CLOTHING." It also shows a country of manufacture (often "MADE IN JAPAN"). As a secondary check, examine button shank stamps. LVC buttons often show different stamp patterns from original factory codes, with slight differences in typeface and layout. The Big E tab is reproduced, but differences appear in fabric texture, natural aging characteristics, and the specifics of how the tab is folded and attached. Price is also a reference point: LVC retails at ¥50,000–¥100,000, but listings claiming "original Big E era" at several hundred thousand yen exist. LVC has its own value as a quality product, but it is categorically separate from authentic vintage.',
      },
      {
        headingJa: 'タブ・ケアラベルの整合性チェック',
        headingEn: 'Tab and Care Label Consistency Check',
        bodyJa: '真贋確認で最も重要な手順が「タブとケアラベルの整合性確認」です。正しい組み合わせ：Big Eタブ＋ケアラベルなし＝1971年以前（正常）。Small eタブ＋ケアラベルあり＝1971年以降（正常）。Big Eタブ＋英語のみのケアラベル＝1971年直後の移行期個体の可能性（慎重に確認）。要注意の組み合わせ：Big Eタブがあるのに多言語ケアラベルや日付コード入りケアラベルがある→タブのすり替えが強く疑われます。日付コードは1984年以降に導入されたため、Big Eと日付コードが共存するのは物理的にありえません。Small eタブなのにケアラベルがない→タブがすり替えられた可能性があります。タブの縫い付けを確認する際は、周辺の縫製糸の退色とタブ本体の退色が一致しているかを確認してください。タブ周囲だけ縫製が新しい、または縫い付け方が生地の他の部分と異なる場合は後付けを疑ってください。',
        bodyEn: 'The single most important authentication step is verifying tab and care label consistency. Correct combinations: Big E tab + no care label = pre-1971 (normal). Small e tab + care label = post-1971 (normal). Big E tab + English-only care label = possible transition-period piece from immediately after 1971 (verify carefully). Warning combinations: Big E tab + multilingual care label or date code care label = tab transplant strongly suspected. Date codes were introduced in 1984 — Big E and date codes cannot physically coexist. Small e tab + no care label = tab may have been replaced. When checking the tab attachment, verify that the surrounding thread aging matches the tab itself. If stitching around the tab looks newer than the rest of the garment, or the attachment technique differs from surrounding construction, suspect a transplant.',
      },
      {
        headingJa: 'ジッパー・ボタン・リベットの確認',
        headingEn: 'Zipper, Button, and Rivet Verification',
        bodyJa: 'ジッパー・ボタン・リベットは偽造が難しく、信頼性の高い確認ポイントです。ジッパーブランドの整合性：Big E期であればTALON（TALON 42または刻印なし）が基本です。現代のプラスチック製YKKジッパーや表面がフラットな現代ジッパーが付いていれば修理交換品または後期品です。ジッパーが交換されていても他の年代指標と照合することで判断できます。ボタン裏の工場コード：「6」「1」「2」などの数字刻印が入っています。数字は工場コードで時代によって組み合わせが異なります。オリジナルは金属が適度に酸化してくすんでおり、新品同様に輝くボタンは交換品の可能性があります。リベットの状態：露出リベット（1937年以前）・隠しリベット（1937〜64年）・バータック（1964年以降）の確認は年代主張との一致確認として有効です。Type Ⅰ・Ⅱの鑑定ではリベット状態・パッチ素材（本革vsJacron）・シンチバックの有無を必ず確認してください。',
        bodyEn: 'Zippers, buttons, and rivets are difficult to fake convincingly, making them reliable verification points. Zipper brand consistency: Big E era should show TALON (TALON 42 or unnumbered). Modern plastic YKK or flat-surface contemporary zippers indicate replacement or later-era pieces. Even when zippers are replaced, cross-referencing with other era indicators allows judgment. Button shank factory codes: stamps like "6," "1," "2" indicate factory origin, with different combinations by era. Original hardware shows appropriate oxidation and dullness — buttons that look freshly polished suggest replacement. Rivet condition: exposed rivets (pre-1937), hidden rivets (1937–64), bartack closure (post-1964) serves as a consistency check against era claims. For Type I & II authentication, always verify: rivet condition, patch material (leather vs Jacron), and cinch back presence.',
      },
      {
        headingJa: '購入前の最終チェックリスト',
        headingEn: 'Final Pre-Purchase Checklist',
        bodyJa: 'ヴィンテージLevi\'sジャケットを購入する際の最終確認事項をまとめます。必須5点確認：①赤タブ（両面確認）→Big EかSmall eか・縫い付けの自然さ②ケアラベル→有無・内容（日付コード・製造国・LEVIS VINTAGE CLOTHINGの有無）③ジッパーブランド→タブの年代と一致するかTALON/YKKを確認④セルビッジ→アウトシームで耳の有無を確認⑤縫製糸の退色→タブ周辺の縫製とタブ本体の退色が合致しているか。追加確認（精密鑑定）：ボタン裏の刻印番号。ポケット構成（Type判別）。パッチ素材（本革かJacronか）。プリーツ有無（Type Ⅱ判別）。ケアラベルの字体・フォーマット（時代ごとに異なる）。写真のみの取引では確認できない部分が多いため、高額個体の購入前には実物確認または信頼できる出品者への追加写真依頼を徹底してください。また出品者がヴィンテージに精通しているかどうか（他の出品物・プロフィール）も判断の参考になります。',
        bodyEn: 'A complete pre-purchase checklist for vintage Levi\'s jackets. Essential five-point check: ①red tab (check both sides) — Big E or Small e; naturalness of attachment stitching ②care label — presence, content (date code, country of manufacture, "LEVIS VINTAGE CLOTHING") ③zipper brand — verify TALON or YKK matches claimed era ④selvedge — check outseam for self-edge ⑤thread aging — tab attachment stitching matches tab\'s own aging level. Additional verification (precision authentication): button shank factory code; pocket configuration (Type identification); patch material (leather or Jacron); pleat presence (Type II check); care label typeface and format (varies by era). Photo-only transactions leave many points unverifiable — for high-value purchases, insist on in-person inspection or request additional close-up photos from the seller. The seller\'s overall vintage knowledge (other listings, profile) also informs confidence.',
      },
    ],
  },
  {
    slug: 'article-jacket-value',
    catJa: '価値・希少性', catEn: 'Value & Rarity',
    titleJa: 'ヴィンテージLevi\'sジャケット相場ガイド2026｜Type別市場価値と価格を決める5要素',
    titleEn: 'Vintage Levi\'s Jacket Price Guide 2026 — Market Values by Type and 5 Value Factors',
    descJa: 'Type Ⅰ〜Ⅲ・Big E/Small e別の市場相場、価格を左右する5要素、売却・購入時の注意点を2026年最新データで解説。',
    descEn: 'Market prices by Type I–III and Big E/Small e era, 5 key value factors, and 2026 buying and selling guidance for vintage Levi\'s jackets.',
    tags: ['相場', '市場価値', 'ジャケット', 'Big E', 'Type1', 'Type2', 'Type3', '売買'],
    publishedAt: '2026-05-31',
    sections: [
      {
        headingJa: '2026年のヴィンテージジャケット市場概況',
        headingEn: 'Vintage Jacket Market Overview in 2026',
        bodyJa: '2026年現在、ヴィンテージLevi\'sジャケット市場は国内外で安定した人気を維持しています。特にBig E期の557XX（トラッカージャケット）は国内のヴィンテージショップ・オークション・フリマアプリで常に高い需要があります。Type Ⅰ（506XX）・Type Ⅱ（507XX）は流通量が極めて少なく、出品があれば即座に注目を集める超希少アイテムです。世界市場（日本・アメリカ・欧州）でのヴィンテージデニムへの関心が高まっており、状態の良い個体の価格は中長期的に上昇傾向にあります。市場を動かす主な要素はType・年代（Big E/Small e）・コンディション・サイズです。同じBig E期の557XXでも、これらの要素によって価格が5〜10倍以上変わることがあります。日本国内市場は世界的に見ても目が肥えた購買層が多く、細部まで確認した上での取引が一般的です。適正な相場感を持つことが、損をしない購入・売却の基本となります。',
        bodyEn: 'In 2026, the vintage Levi\'s jacket market maintains stable popularity domestically and internationally. Big E era 557XX Trucker Jackets in particular see consistent high demand across domestic vintage stores, auctions, and resale apps. Type I (506XX) and Type II (507XX) circulate so rarely that any listing immediately attracts collector attention. Growing worldwide interest in vintage denim is pushing quality-piece prices upward over the medium term. The main market drivers are Type, era (Big E/Small e), condition, and size — the same Big E era 557XX can vary 5–10x in price based on these factors alone. Japan\'s domestic market features a particularly discerning buyer base, with transactions typically following careful multi-point verification. Understanding correct market pricing is the foundation for buying and selling without loss.',
      },
      {
        headingJa: 'Type別・年代別 相場一覧（2026年版）',
        headingEn: 'Price Guide by Type and Era (2026)',
        bodyJa: '2026年の市場での目安価格を以下に示します（コンディション：良好以上を前提とします）。Type Ⅰ（506XX）：シンチバックあり・Big E・本革パッチの初期個体→80〜300万円以上。通常のType Ⅰ・Big E期→30〜100万円。Type Ⅱ（507XX）：本革パッチあり・Big E期→30〜120万円。通常のType Ⅱ・Big E期→20〜80万円。Type Ⅲ（557XX）Big E期：TALONジッパー＋セルビッジあり→8〜40万円。TALONジッパー・セルビッジなし→5〜15万円。Type Ⅲ Small e期（1971〜1981年）：セルビッジあり→1〜6万円。セルビッジなし→3,000〜20,000円。Type Ⅲ（1981年以降）：サイドポケットあり→3,000〜10,000円。これらはあくまで目安であり、極端に良好なコンディション（未着用・デッドストック）の場合は上限を大幅に超えることがあります。逆にダメージが大きい・修理跡あり・洗いすぎによる均一色落ちの個体は評価が下がります。',
        bodyEn: 'Indicative 2026 market prices (assumes good or better condition). Type I (506XX): early examples with cinch back, Big E, leather patch → ¥800,000–¥3,000,000+. Standard Type I, Big E era → ¥300,000–¥1,000,000. Type II (507XX): leather patch, Big E → ¥300,000–¥1,200,000. Standard Type II, Big E → ¥200,000–¥800,000. Type III (557XX) Big E era: TALON zipper + selvedge → ¥80,000–¥400,000. TALON, no selvedge → ¥50,000–¥150,000. Type III Small e (1971–1981): selvedge → ¥10,000–¥60,000. No selvedge → ¥3,000–¥20,000. Type III (post-1981): side pockets present → ¥3,000–¥10,000. These are guidelines; deadstock/unworn examples may far exceed upper limits. Heavy damage, repair marks, or uniform over-washing reduces values significantly.',
      },
      {
        headingJa: '価値を左右する5つの要素',
        headingEn: '5 Key Factors That Determine Value',
        bodyJa: 'ジャケットの価値を決める5要素を重要度順に解説します。①年代（Big E/Small e）：最重要要素です。同じType Ⅲでも、Big E期とSmall e期では価格が5〜10倍以上異なる場合があります。Big Eタブ＋ケアラベルなしの確認が基本です。②コンディション：未着用・極美品から着用感ありまで段階的に評価が変わります。特に前面のダメージ（ポケット破れ・ボタン欠損・色落ち均一化）は評価に大きく影響します。③サイズ：42以上の大サイズは需要に対して流通量が少なくプレミアムが付くことがあります。アメリカ市場では大サイズへの需要が特に高い傾向があります。④セルビッジデニムの有無：同年代でもセルビッジ使用品は非使用品より評価が高くなります。Big E期でもセルビッジあり・なしで2〜3倍の価格差があります。⑤オリジナリティ：ジッパー・ボタン・タグがすべてオリジナルのままであることが高評価の条件です。修理交換はオリジナリティを損ない、査定額を下げる要因となります。この5要素が全て最高評価の個体はコレクター市場で「ヒットコンディション」と呼ばれ、通常より大幅に高い価格がつきます。',
        bodyEn: '5 value factors in order of importance. ①Era (Big E/Small e): the most critical factor. The same Type III can differ 5–10x in price between Big E and Small e. Confirming Big E tab + no care label is baseline. ②Condition: values grade down from unworn/mint through worn. Front-surface damage (pocket tears, missing buttons, uniform fading) most significantly impacts assessment. ③Size: larger sizes (42+) see higher demand than supply in the market, especially from American buyers. ④Selvedge denim presence: within the same era, selvedge examples command premiums over non-selvedge — 2–3x price differences exist within Big E era alone. ⑤Originality: all zippers, buttons, and tags must remain original for top assessment. Replacement repairs compromise originality and reduce valuation. An example scoring at the top of all 5 factors is called "hit condition" in collector circles, commanding substantially above-market prices.',
      },
      {
        headingJa: '売却時に知っておくべきポイント',
        headingEn: 'Key Points for Selling',
        bodyJa: 'ヴィンテージLevi\'sジャケットを売却する際の重要ポイントをまとめます。写真の重要性：①赤タブ（両面）②ケアラベル③ジッパーブランド④アウトシーム（セルビッジ確認）⑤全体（正面・背面）⑥ポケット内部（プリーツ・隠しリベット確認）の写真を揃えることで信頼性が高まり、適正価格での早期売却が期待できます。売却先の選択肢：国内フリマアプリ（メルカリ・ラクマなど）は手軽ですが、ヴィンテージ知識がある購買層に届くかは運次第です。国内ヴィンテージ専門店への持ち込みは即現金化できますが、買取価格は市場の40〜60%になることが多いです。海外向けオークション（eBay）はアメリカ・欧州のコレクターに直接届くため、希少品は高値がつく場合がありますが英語対応と送料・関税の手間がかかります。価格設定：同条件の直近落札価格を複数確認してから設定してください。感情的な価格設定（思い入れが強すぎる）は売れ残りの原因になります。適正な相場より10〜15%高めから始めて交渉に応じる方法が売却しやすいとされています。',
        bodyEn: 'Key points for selling vintage Levi\'s jackets. Photography essentials: providing photos of ①red tab (both sides), ②care label, ③zipper brand, ④outseam (selvedge check), ⑤overall (front and back), ⑥pocket interior (pleats and hidden rivets) builds buyer confidence and supports early sale at appropriate prices. Sales channels: domestic resale apps (Mercari, Rakuma) are convenient but reaching knowledgeable buyers depends on luck. Consigning to domestic vintage specialists provides immediate cash but typically yields 40–60% of market value. International auction (eBay) reaches American and European collectors directly, potentially achieving higher prices for rare items, but requires English communication and handles shipping/customs complications. Pricing: verify several recent completed sales of equivalent items first. Emotionally inflated pricing causes items to linger. Starting 10–15% above fair market value with willingness to negotiate is generally considered the most effective approach.',
      },
      {
        headingJa: 'コレクションとしてのジャケット投資・保管',
        headingEn: 'Jacket Collecting, Investment, and Storage',
        bodyJa: 'ヴィンテージLevi\'sジャケット、特にType Ⅰ・Ⅱや状態の良いBig E期Type Ⅲは、ファッションアイテムとしてだけでなく価値が安定しているコレクタブルとして注目を集めています。過去10〜15年のデータでは、状態の良い506XX・507XXの価格は右肩上がりで推移しており、他のヴィンテージファッションアイテムと比較しても相対的に安定した価値を維持しています。コレクタブルとして保有する場合、適切な保管環境が重要です。直射日光・高湿度・虫食いは価値を著しく損ないます。温湿度管理ができる場所での保管と定期的な状態確認を推奨します。長期的に価値を維持するにはオリジナリティの保持が最重要です。ダメージがある場合は修理前に専門家に相談し、修理による価値への影響を確認してから判断してください。初心者の方はまずSmall e期の557XXから収集を始めて相場感を身につけ、その後Big E期やType Ⅰ・Ⅱへと段階的に移行することをお勧めします。ヴィンテージLevi\'sジャケットは着用しながら価値を楽しめる数少ないコレクタブルのひとつです。',
        bodyEn: 'Vintage Levi\'s jackets — especially Type I & II and quality Big E era Type III — attract attention not just as fashion items but as collectibles with stable value. Over the past 10–15 years, quality 506XX and 507XX prices have trended upward, maintaining relatively stable value compared to other vintage fashion categories. For collectible holding, appropriate storage is critical: direct sunlight, high humidity, and insect damage significantly diminish value. Storage in a temperature- and humidity-controlled environment with periodic condition checks is recommended. Maintaining originality is paramount for long-term value preservation. If damage is present, consult a specialist before any repair — understand the value impact before proceeding. For beginners, starting with Small e era 557XX builds market intuition before moving progressively to Big E era and then Type I & II. Vintage Levi\'s jackets are among the rare collectibles you can wear and enjoy while they hold their value.',
      },
    ],
  },
];
